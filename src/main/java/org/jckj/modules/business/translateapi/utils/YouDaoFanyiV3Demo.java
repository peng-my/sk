...
public class YouDaoFanyiV3Demo {
    ...
    private static Logger logger = LoggerFactory.getLogger(YouDaoFanyiV3Demo.class);
    ...
    public static void requestForHttp(String url,Map<String,String> params) throws IOException {
        ...
        RequestConfig requestConfig =  RequestConfig.custom().setSocketTimeout(10000).setConnectTimeout(10000).build();//设置超时时间
